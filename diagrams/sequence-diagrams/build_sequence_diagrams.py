...
def detailed_pages() -> list[dict]:
    return [
        ...
        page(
            ...
            "Use Case Spec §16 · PRD Module AC",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("state", "Research State"),
            ...
            [
                ...
                call("web", "state", "06. Mark Post-hoc / Exploratory + Unverified"),
                returning("state", "web", "07. Candidate metadata saved"),
                returning("web", "researcher", "08. Display candidate list"),
                call("researcher", "web", "09. Inspect / edit / discard / request more"),
                call("web", "agent", "10. Generate more candidates if requested"),
                returning("agent", "web", "11. Additional candidate set"),
                returning("web", "researcher", "12. Candidate set ready for selection gate"),
            ],
            [loop_fragment("candidate-generation", 3, 8, "[more candidates needed]")],
        ),
        page(
            "UC-11 Review / Resolve Hypothesis Selection Decision - Main Flow",
            "Use Case Spec §17 · PRD Module AD",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
            ...
            [
                ...
                returning("gate", "web", "05. SELECT / REJECT / ESCALATE / NO_SUITABLE"),
                call("web", "state", "06. Save Decision Record + confidence / reasons"),
                returning("state", "web", "07. Decision history persisted"),
                returning("web", "researcher", "08. Decision + review task"),
                call("researcher", "web", "09. Approve / modify / override / reject"),
                call("web", "state", "10. Set active direction or record outcome"),
                returning("state", "web", "11. Active direction / outcome saved"),
                returning("web", "researcher", "12. Direction ready for planning"),
            ],
            [
                alt_fragment(
                    "selection-outcome",
        ...
        page(
            ...
            [
                ...
                call("web", "agent", "04. Generate structured experiment plan"),
                returning("agent", "web", "05. Objective, variables, methods, checks, risks"),
                returning("web", "researcher", "06. Display plan for review"),
                call("researcher", "web", "07. Accept / request revision / cancel"),
                call("web", "agent", "08. Revise plan if requested"),
                returning("agent", "web", "09. Revised plan"),
                call("web", "state", "10. Persist accepted plan = Ready"),
                returning("state", "web", "11. Plan state saved"),
                returning("web", "researcher", "12. Plan ready for method review"),
            ],
            [opt_fragment("plan-revision", 7, 8, "[Request Revision]")],
        ),
        page(
            "UC-13 Review Method Selection & Assumption Checks - Main Flow",
            "Use Case Spec §19 · PRD Modules I/J",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("agent", "AI Research Agent"),
            ...
            [
                ...
                call("web", "agent", "06. Compare candidates + select suitable method"),
                returning("agent", "web", "07. Selected method + rationale + alternatives"),
                returning("web", "researcher", "08. Display method + assumption results"),
                call("researcher", "web", "09. Review / confirm method"),
                call("web", "method", "10. Persist selected method + rationale"),
                returning("method", "web", "11. Method decision saved"),
                returning("web", "researcher", "12. Method ready for execution"),
            ],
            [
                alt_fragment(
                    "method-result",
        ...
        page(
            ...
            "Use Case Spec §20 · PRD Module L / Execution Trace",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("agent", "AI Research Agent"),
            ...
            [
                ...
                call("web", "agent", "02. Create Execution Run"),
                call("agent", "router", "03. Select required tool"),
        ...
        page(
            ...
            "Use Case Spec §21 · PRD Modules M/N/O/P",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("validator", "Scientific Validator"),
        ...
        page(
            ...
            "Use Case Spec §22 · PRD Module AE",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("state", "Research State"),
            ...
            [
                ...
                call("web", "gate", "04. Evaluate stats, CI, assumptions, consistency, uncertainty"),
                returning("gate", "web", "05. ENOUGH / NEED_MORE / ALTERNATIVE / REPLICATE / HUMAN / INCONCLUSIVE"),
                call("web", "state", "06. Save Evidence Decision Record + reasons"),
                returning("state", "web", "07. Decision history persisted"),
                returning("web", "researcher", "08. Outcome + review task"),
                call("researcher", "web", "09. Confirm / override if required"),
                call("web", "state", "10. Route outcome to finding / refinement / loop"),
                returning("web", "researcher", "11. Next action available"),
            ],
            [
                alt_fragment(
                    "evidence-outcome",
                    ...
                    "else [UC-17 refinement / human review / UC-20]",
                )
            ],
        ),
        page(
        ...
        page(
            ...
            "Use Case Spec §24 · PRD Modules Q/X",
            [
                participant("researcher", "Researcher / Reviewer", True),
                participant("web", "Web App"),
                participant("agent", "AI Research Agent"),
            ...
            [
                ...
                call("agent", "provenance", "03. Assemble H / E / dataset / method / validation / gate"),
                ...
                call("researcher", "web", "07. Set Validated / Review / Rejected / Conflict / Invalidated"),
                call("web", "provenance", "08. Check + save finding status"),
                returning("provenance", "web", "09. Finding state saved"),
                call("web", "state", "10. Update Research State if validated"),
        ...
        page(
            ...
            "Use Case Spec §25 · PRD Modules S/T",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
                participant("dependency", "Dependency Service"),
            ...
            [
                call("researcher", "web", "01. Open dependency / conflict view"),
                call("web", "dependency", "02. Load RQ → State → H → E → Finding graph"),
                ...
                call("researcher", "web", "07. Inspect edge / review conflict"),
                call("web", "dependency", "08. Identify descendants + create Conflict Record"),
                call("dependency", "agent", "09. Recommend re-run / refine / preserve action"),
                returning("agent", "dependency", "10. Recommended next action"),
                call("dependency", "store", "11. Preserve results; mark Needs Re-validation"),
        ...
        page(
            ...
            [
                ...
                call("web", "state", "02. Load evidence, candidates, conflicts, budgets"),
                returning("state", "web", "03. Current research state"),
                call("web", "state", "04. Evaluate stopping criteria"),
                ...
                call("web", "state", "09. Route [Continue] → UC-10 or [Stop] → Completed"),
        ...
        page(
            ...
            "Use Case Spec §27 · PRD Modules V/W/Z",
            [
                participant("researcher", "Researcher", True),
                participant("web", "Web App"),
            ...
            [
                call("researcher", "web", "01. Choose figure / table / report / package"),
                call("web", "findings", "02. Load eligible validated findings + metadata"),
                returning("findings", "web", "03. Findings + provenance context"),
                call("web", "agent", "04. Generate evidence-backed output"),
                call("agent", "output", "05. Create figure / table / report artifact"),
                returning("output", "agent", "06. Artifact + reproducibility metadata"),
                returning("agent", "web", "07. Output + source linkage"),
                returning("web", "researcher", "08. Display output for review"),
                call("researcher", "web", "09. Review + save / export"),
                call("web", "output", "10. Persist / export final artifact"),
                returning("output", "web", "11. Export record"),
                returning("web", "researcher", "12. Final output confirmation"),
            ],
        ),
        page(
            "UC-22 View Research Outputs, Provenance, Evidence, Trace & Decision History - Main Flow",
            "Use Case Spec §28 · PRD Modules X/Y/AG",
            [
                participant("researcher", "Researcher / Reviewer", True),
                participant("web", "Web App"),
                participant("provenance", "Provenance Service"),
            ...
            [
                ...
                call("web", "provenance", "02. Load provenance chain"),
                call("provenance", "history", "03. Load evidence gate + validation decisions"),
                returning("history", "provenance", "04. Decision inputs, outcomes, overrides"),
                call("provenance", "trace", "05. Load execution trace + artifacts"),
        ...
        page(
            ...
            "Use Case Spec §29 · PRD Module AA/AG",
            [
            ...
            [
                call("researcher", "web", "01. Choose benchmark, config(s), N"),
                call("web", "config", "02. Load model + decision-provider configuration"),
        ...
        page(
            ...
            "Use Case Spec §30 · PRD Module AG / Admin",
            [
            ...
            [
                ...
                call("console", "config", "02. Load models, providers, thresholds, logs, cost"),
...
COMPACT_ALT_HEADERS = {
    ...
    "selection-outcome": "alt [SELECT / else review]",
