...
The runtime `use_case` item is represented here as a business-capability map. The detailed behavior remains in the Functional Requirements section.

#### BC-01: Research Workspace and Access Control
- **goal:** Establish an isolated project workspace with authentication and role enforcement.
- **user_segment:** Researcher, Research Project Manager, System Administrator.
- **business_value:** Keeps research work governed, discoverable, and separated by project membership.
- **scope:** Feature Modules A–B.

#### BC-02: Dataset Understanding and Quality
- **goal:** Upload, profile, validate, clean, and version structured research datasets.
- **user_segment:** Researcher / Data Analyst.
- **business_value:** Improves data readiness while preserving the original dataset and lineage.
- **scope:** Feature Modules C–E.

#### BC-03: Research Framing and Hypothesis Management
- **goal:** Capture research questions, context, hypotheses, origins, status, and research state.
- **user_segment:** Researcher / Data Analyst, Research Project Manager.
- **business_value:** Makes research intent explicit and separates candidate ideas from validated findings.
- **scope:** Feature Modules F–G and AC.

#### BC-04: Experiment Planning and Method Selection
- **goal:** Generate, compare, justify, and revise experiment plans and candidate methods.
- **user_segment:** Researcher / Data Analyst.
- **business_value:** Reduces method-selection error and makes assumptions visible before execution.
- **scope:** Feature Modules H–J.

#### BC-05: Bounded Execution and Scientific Validation
- **goal:** Execute experiments safely, retry or re-plan when needed, and validate scientific results.
- **user_segment:** Researcher / Data Analyst, Reviewer / Stakeholder.
- **business_value:** Prevents unsupported conclusions through deterministic checks, bounded branching, and leakage control.
- **scope:** Feature Modules K–P and U.

#### BC-06: Findings, Evidence, Dependencies, and Reproducibility
- **goal:** Manage findings, evidence, refinement, conflicts, dependencies, provenance, traces, and snapshots.
- **user_segment:** Researcher / Data Analyst, Reviewer / Stakeholder.
- **business_value:** Enables traceable, auditable, and reproducible research conclusions.
- **scope:** Feature Modules Q–T and X–Z.

#### BC-07: Evaluation and Decision Governance
- **goal:** Evaluate the agent, record decisions, enforce gates, manage configuration, telemetry, and cost.
- **user_segment:** Research Project Manager, Reviewer / Stakeholder, System Administrator.
- **business_value:** Makes automation measurable, reviewable, and safe to operate.
- **scope:** Feature Modules AA–AG and AB.

#### BC-08: Research Outputs and Ideation Quality
- **goal:** Produce reviewed figures, tables, manuscripts, and structured ideation outputs.
- **user_segment:** Researcher / Data Analyst, Reviewer / Stakeholder.
- **business_value:** Shortens the path from validated evidence to reviewable research communication.
- **scope:** Feature Modules V–W and AH.

<!-- Source sections: 1. Product Summary; 2. Product Vision; 3. Product Goals; 4. Non-Goals; 5. Target Users & Roles; 6. Product Principles; 7. Product Scope & Priority; 8. Information Architecture; 9. Primary End-to-End User Flow -->
...
<!-- Source sections: 10. Feature Module A — Authentication & Access Control; 11. Feature Module B — Research Project Workspace; 12. Feature Module C — Dataset Upload & Validation; 13. Feature Module D — Automatic Profiling & Data Card; 14. Feature Module E — Data Quality, Cleaning & Versioning; 15. Feature Module F — Research Question & Research Context; 16. Feature Module G — Hypothesis Management; 17. Feature Module H — Experiment Planner; 18. Feature Module I — Candidate Method Generation & Selection; 19. Feature Module J — Assumption Checking; 20. Feature Module K — Limited Experiment Branching; 21. Feature Module L — Secure Experiment Execution; 22. Feature Module M — Statistical & Scientific Validation; 23. Feature Module N — Multiple-Testing Control; 24. Feature Module O — Effect Size, Confidence Interval & Uncertainty; 25. Feature Module P — Data Leakage Guard; 26. Feature Module Q — Finding Management; 27. Feature Module R — Hypothesis Refinement; 28. Feature Module S — Experiment Dependency Graph; 29. Feature Module T — Conflicting Evidence; 30. Feature Module U — Stopping Criteria; 31. Feature Module V — Visualization & Figure Review; 32. Feature Module W — Research Outputs & Report; 33. Feature Module X — Provenance & Evidence; 34. Feature Module Y — Execution Trace; 35. Feature Module Z — Reproducibility Snapshot; 36. Feature Module AA — Evaluation Center; 37. Feature Module AB — Admin, Telemetry & Cost; 37.1. Feature Module AC — Research State & Candidate Hypothesis Generation; 37.2. Feature Module AD — Structured Hypothesis Selection Gate; 37.3. Feature Module AE — Evidence Sufficiency Gate; 37.4. Feature Module AF — Scientific Refinement & Confidence-Based Escalation; 37.5. Feature Module AG — Decision Audit, Configuration & Gate Evaluation; 37.6. Feature Module AH — Ideation Quality & Manuscript Reporting; 38. Agent Runtime Product Behavior; 39. Human-in-the-Loop Decision Policy; 40. Product State Models; 41. Core UI Screens; 42. Error & Empty States; 43. Notifications & Review Tasks; 44. High-Level Data Entities; 45. High-Level Relationship Model; 48. Product Acceptance Criteria; 49. Release Plan; 50. BRD → PRD Traceability; 51. Research Evaluation Alignment; 54. Recommended MVP Demo Scenario -->

### Feature Module A — Authentication & Access Control
...
### Feature Module B — Research Project Workspace
...
### Feature Module C — Dataset Upload & Validation
...
### Feature Module D — Automatic Profiling & Data Card
...
### Feature Module E — Data Quality, Cleaning & Versioning
...
### Feature Module F — Research Question & Research Context
...
### Feature Module G — Hypothesis Management
...
### Feature Module H — Experiment Planner
...
### Feature Module I — Candidate Method Generation & Selection
...
### Feature Module J — Assumption Checking
...
### Feature Module K — Limited Experiment Branching
...
### Feature Module L — Secure Experiment Execution
...
### Feature Module M — Statistical & Scientific Validation
...
### Feature Module N — Multiple-Testing Control
...
### Feature Module O — Effect Size, Confidence Interval & Uncertainty
...
### Feature Module P — Data Leakage Guard
...
### Feature Module Q — Finding Management
...
### Feature Module R — Hypothesis Refinement
...
### Feature Module S — Experiment Dependency Graph
...
### Feature Module T — Conflicting Evidence
...
### Feature Module U — Stopping Criteria
...
### Feature Module V — Visualization & Figure Review
...
### Feature Module W — Research Outputs & Report
...
### Feature Module X — Provenance & Evidence
...
### Feature Module Y — Execution Trace
...
### Feature Module Z — Reproducibility Snapshot
...
### Feature Module AA — Evaluation Center
...
### Feature Module AB — Admin, Telemetry & Cost
...
### Feature Module AC — Research State & Candidate Hypothesis Generation
...
### Feature Module AD — Structured Hypothesis Selection Gate
...
### Feature Module AE — Evidence Sufficiency Gate
...
### Feature Module AF — Scientific Refinement & Confidence-Based Escalation
...
### Feature Module AG — Decision Audit, Configuration & Gate Evaluation
...
### Feature Module AH — Ideation Quality & Manuscript Reporting
...
<!-- Source sections: 46. Non-Functional Requirements; 47. Product Metrics; 52. Key Product Risks; 53. Open Product Decisions; 55. Definition of Done — Product Level; 56. Next Documents; 57. Document Change Log -->
